...
<div
  class="bg-scroll"
  style="background-image: url('{{ site.baseurl }}/media/img/mountain1.jpg')"
></div>
```
...
```html
![]({{ site.baseurl }}/media/img/mountain3.gif#right) ![]({{ site.baseurl
}}/media/img/mountain2.gif#left)
```
...
```html
<div class="large">![]({{ site.baseurl }}/media/img/mountain2.jpg)</div>
```
...
```html
<iframe
  src="https://view.officeapps.live.com/op/embed.aspx?src=http://img.labnol.org/di/PowerPoint.ppt"
  frameborder="0"
></iframe>
```
